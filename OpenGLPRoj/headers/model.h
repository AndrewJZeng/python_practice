...
public:
    ...
    void SetModelTranslation(float xPos, float yPos, float zPos) {
        x = xPos;
        y = yPos;
        z = zPos;
    }
    
    void ChangeModelTranslation(float xPos, float yPos, float zPos) {
        x += xPos;
        y += yPos;
        z += zPos;
    }
    ...
    void SetModelRotation(float rad, float x, float y, float z) {
        rotation = glm::rotate(glm::mat4(1.0f), rad, glm::vec3(x, y, z));
    }
    
    void SetModelScale(float scaleFac) {
